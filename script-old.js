...
const questions = {
	...
	nuppisierung: {
		...
		question:
			"80 Prozent der regionalen Tageszeitungen gehören zu einem Unternehmen. Dieses wurde allerdings von einem größeren Verlag aus dem Nachbarland aufgekauft. Außerdem gehören diesem Konzern auch viele Online-Nachrichtenplattformen, die in den letzten Jahren extrem gewachsen sind. Was bedeutet das für uns?",
		answers: [
			{
	...
	erklaerung1: {
		question:
			"Ausländische Auftraggeber können dir so viel leichter in die Berichterstattung deines Landes reden. Und das kann wiederum dem Ansehen deiner Partei schaden.",
		answers: [
			{
				text: "Verstehe.",
				goto: "aufkaufen",
	...
	geld: {
		question:
			"Richtig! Hinzu kommt, dass du natürlich auch weniger Geld im Land behalten kannst, wenn es so weit kommt.",
		answers: [
			{
				text: "Okay.",
				goto: "aufkaufen",
	...
	pressefreiheit: {
		question:
			"Uhh, ganz schlechte Idee. Die anderen Länder der Adrejanischen Union haben uns doch eh schon auf dem Kieker. Wenn wir jetzt noch einen großen Teil der lokalen Presse kaufen, wird das nicht gut enden. Wie machen wir weiter?",
		answers: [
			{
	...
	buchhandel: {
		question:
			"Kein schlechter Gedankengang. Trotzdem ist das leider etwas verdächtiger als ein Unternehmen, was scheinbar wenig mit Medien, deren Vertrieb und Organisation zu tun hat. Aber immerhin ist die Buchhandelskette bereits etabliert und bekannt.",
		info: 'Tatsächlich hält Polen ein gutes Viertel der Aktien des Öl- und Tankstellenkonzerns Orlen. Das "polnische Gazprom" hat diese Tageszeitungen und die zugehörigen Internetportale - die "Polska Press" - aufgekauft und viele der Chefredakteur*innen ausgetauscht. Mehr Infos dazu findest du <a href=https://www.tagesschau.de/ausland/europa/polen-orlen-medien-101.html>hier</a>.',
		answers: [
			{
				text: "Weiter geht's.",
	...
	pr: {
		question:
			"Nicht deine beste Idee, um ehrlich zu sein. Wenn ein Haufen Zeitungstitel und Onlineportale von einer PR-Agentur aufgekauft werden, wo der Staat seine Finger mit im Spiel hat, werden natürlich alle misstrauisch. Versuch doch nächstes mal, etwas subtiler zu agieren.",
		info: 'Tatsächlich hält Polen ein gutes Viertel der Aktien des Öl- und Tankstellenkonzerns Orlen. Das "polnische Gazprom" hat diese Tageszeitungen und die zugehörigen Internetportale - die "Polska Press" - aufgekauft und viele der Chefredakteur*innen ausgetauscht. Mehr Infos dazu findest du <a href=https://www.tagesschau.de/ausland/europa/polen-orlen-medien-101.html>hier</a>.',
		answers: [
			{
	...
	nachfrage2: {
		question:
			"Hältst du das echt für schlau? Wir hatten doch davor schon überlegt, dass es ganz schlau wäre, da etwas zu ändern.",
		answers: [
			{
	...
	massaker: {
		...
		question:
			"Du hast dich ja vorhin schon ziemlich unbeliebt damit gemacht, dass du das ausländische Medienunternehmen aufgekauft hast. Die meisten Tageszeitungen und großen Internetportale sind jetzt also Staatsmedien. Trotzdem publizieren sie bisher genau wie vorher.",
		answers: [
			{
	...
	gleich2: {
		question:
			"Laaaaangweilig. Weißt du, dass du so deinen Kritiker*innen das Feld komplett überlässt? Kein Wunder, dass eure Umfragewerte sinken. Klar freuen sich alle über eine bunte Medienlandschaft, aber stell dir bloß mal vor, was du alles mit ein paar Einschränkungen erreichen könntest.",
	...
	entlassen2: {
		question:
			"Sehr gut. Wenn die Chefpositionen mit regierungstreuen Leuten besetzt sind, schüchtert das wahrscheinlich auch die Journalist*innen in den Redaktionen schon etwas ein.",
		info: "In den großen Städten ist es leichter, Ersatz zu finden, während Lokalzeitungen in dieser Hinsicht weniger Macht haben. Mehr zur Ersetzung der Journalist*innen findest du in <a href =https://www.deutschlandfunkkultur.de/medienpolitik-in-polen-angriff-auf-die-pressefreiheit.979.de.html?dram:article_id=496143>diesem Artikel vom Deutschlandfunk</a>.",
		answers: [
			{
	...
	zensur: {
		...
		question:
			"Im öffentlich-rechtlichen Fernsehen äußert sich eine beliebte Moderatorin kritisch zu einem neuen Gesetzentwurf. Wie regierst du am besten?",
		answers: [
			{
	...
	entlassen: {
		question:
			"Klar, im Ausland kennt sie kaum jemand, und im Inland schieben wir einfach einen Grund vor, wenn du magst. Hast du eine Idee?",
	...
	krank: {
		question:
			"Von der Bildfläche komplett verschwinden darf sie natürlich nicht. Ansonsten aber eine ganz gute Wahl, denke ich.",
		answers: [
			{
	...
	nichts: {
		question:
			"Keine schlafenden Hunde wecken, würde ich auch sagen. Ein paar Journalisten sind misstrauisch geworden, aber lass' uns da erstmal abwarten.",
		answers: [
			{
				text: "Was machen wir als nächstes?",
				variables: [
	...
	wahrheit: {
		question:
			"Mhhh, schwierig. So lenkst du natürlich noch mehr Aufmerksamkeit auf das ganze Thema. Wahrscheinlich wäre es besser gewesen, alles zu verschweigen. Aber mit deiner Vermutung, dass so mehr Journalist*innen weniger Kritisches schreiben, lagst du richtig.",
		answers: [
			{
				text: "Weiter geht's!",
				variables: [
	...
	drohung: {
		question:
			"Wow, mutig! Aber nicht verkehrt: Das hat ziemlich viele kritische Journalist*innen eingeschüchtert. Im Ausland kommt das natürlich nicht so gut an. Die wird so schnell nichts mehr gegen die WhR sagen.",
	...
	obama: {
		...
		question:
			'Ein Präsident eines großen wichtigen Staates sagt auf einer Veranstaltung in Nuppland: "Wir blicken besorgt auf die nuppische Demokratie. Die demokratischen Verfahren werden zunehmend abgebaut, obwohl es wichtig ist, dass alle Staaten zusammenarbeiten. Nuppland ist als Beispiel für die ganze Welt zu sehen."',
		answers: [
			{
	...
	wahrheit2: {
		question:
			"Du hast Recht. Falls das auffliegt, fliegt uns hier alles um die Ohren. Die Äußerung wird natürlich auch in den anderen Ländern wahrgenommen werden, aber besser stehen wir auch selbst dazu.",
	...
	verschweigen: {
		question:
			"Können wir natürlich versuchen. Aber falls das noch rauskommt, haben wir echt ein Problem.",
		answers: [
			{
	...
	wahrheit2a: {
		question:
			"Na gut, immerhin haben wir ihm nicht die Worte im Munde verdreht. Trotzdem haben es einige im In- und Ausland mitbekommen... Da sind einige Regierungskritiker*innen dazu gekommen.",
		info: "Eine ähnliche Aussage gab es 2016 vom damaligen US-Präsidenten Barack Obama über Polen. Tatsächlich wurde die Aussage in der Übersetzung komplett verdreht, von einem mahnenden Ton zu einem lobenden. Obwohl das einigen aufgefallen ist, hat es keine großen Wellen geschlagen.",
		answers: [
			{
	...
	wahrheit2b: {
		question:
			'Die nuppische Pressefreiheit wird im Ausland echt als gefährdet angesehen. Kürzlich kam eine Rangliste der NGO "Journalisten um die Welt" heraus, in dem Nuppland immer weiter abrutscht.',
		answers: [
			{
	...
	manipulation: {
		question:
			'Riskant. Aber gut. Dann übersetzen wir den Satz also... "Wir blicken [...] auf die nuppische Demokratie. [Die demokratischen Verfahren werden zunehmend abgebaut, obwohl] es [ist] wichtig [...], dass alle Staaten zusammenarbeiten. Nuppland ist als Beispiel für die ganze Welt zu sehen." Passt?',
		answers: [
			{
	...
	manipulation2: {
		question:
			"Wie es scheint, ist unsere kleine Änderung wohl aufgefallen: Ein ganzer Schwung an kritischen Journalisten ist dazugekommen. Wie wollen wir uns da rausreden?",
		info: "Eine ähnliche Aussage gab es 2016 vom damaligen US-Präsidenten Barack Obama über Polen. Tatsächlich wurde die Aussage in der Übersetzung komplett verdreht, von einem mahnenden Ton zu einem lobenden. Obwohl das einigen aufgefallen ist, hat es keine großen Wellen geschlagen.",
		answers: [
			{
	...
	manipulation22: {
		question:
			"Okay, jetzt fühlen sich alle auf den Arm genommen und sind ziemlich sauer auf dich. Sowohl deine Partei als auch deine Beziehungen ins adrejanische Ausland leiden.",
		answers: [
			{
				text: "Aussitzen.",
				variables: [
	...
	manipulation23: {
		question:
			"Den letzten Teil, dass es nicht absichtlich war, glaubt dir zwar fast niemand, aber die Wogen haben sich schnell geglättet.",
		answers: [
			{
				text: "Glück gehabt.",
				variables: [
	...
	manipulation2a: {
		question:
			"Glück gehabt. Nur ein paar wenige sind misstrauisch geworden. Lass' uns schnell weitermachen, damit das nicht weiter auffällt.",
	...
	linie: {
		...
		question:
			"Um die Nachrichten jetzt noch etwas auf Linie zu bringen, habe ich verschiedene Ideen. Was meinst du, eignet sich besonders gut?",
		answers: [
			{
	...
	agentur: {
		question:
			"Mein Vorschlag ist, eine Nachrichtenagentur zu gründen, die eng verbunden mit der Regierung ist. Die könnte die Recherche für kleinere Redaktionen vereinfachen, aber natürlich auch dazu verleiten, dass sie Nachrichten veröffentlichen, die schon vorgefiltert sind.",
	...
	kesma: {
		question:
			'Gut, du hast die Stiftung ZMSN ("Zentrale Medienstiftung Nuppland") gegründet. Abseits vom öffentlich-rechtlichen Rundfunk sind natürlich auch die vielen lokalen Medien, Druckereien und Internetportale Mitglied, die jetzt endlich in nuppländischer Hand sind. Vor allem also regierungsnahe Medien, viele davon in der Hand von Bekannten und Freunden von dir. Trotzdem gibt es natürlich noch viel Oppositionelles, gerade im Netz.',
	...
	briefing: {
		question:
			"Die Zahl der kritischen Journalist*innen hat abgenommen. Aber eher, weil sich zumindest die bei den Medien in der Stiftung niemand mehr traut, etwas Kritisches zu schreiben - sehr gut!",
	...
	subventionen: {
		question:
			"Gute Idee. So schaffst du Anreize, der Stiftung sogar freiwillig beizutreten, aber damit würden kritische Medien natürlich auch ein Stück ihrer Unabhängigkeit aufgeben und staatsnäher werden.",
	...
	lizenzB: {
		question:
			"Es gibt da einen größeren kritischen Radiosender, der bei der Beantragung seiner Sendefrequenz ein paar kleinere Fehler gemacht hat.",
		answers: [
			{
	...
	lizenz2B: {
		question:
			"Ziemlich lasch. Dein Handeln wurde nicht wirklich ernst genommen, der Sender ist sogar gewachsen. Aber lass' uns keine große Sache draus machen.",
	...
	lizenz3B: {
		question:
			"Super Idee! Auch, wenn der Sender online noch weiter sendet, erreicht er so nur noch einen Bruchteil der Hörer*innen, und kann sich so natürlich auch schlechter finanzieren.",
		info: 'In Ungarn wurde dem Radiosender "Klubradio", einem der wenigen oppositionellen Medien, wegen einer solchen Bagatelle die Lizenz entzogen. Mittlerweile ist der Sender nur noch <a href=https://www.klubradio.hu/>übers Internet zu hören</a>. <a href=https://www.tagesschau.de/ausland/europa/ungarn-pressefreiheit-103.html>Hier</a> findest du mehr zum Entzug der Lizenz.',
		answers: [
			{
				text: "What's next?",
	...
	lizenz2: {
		question:
			"Ziemlich lasch. Dein Handeln wurde nicht wirklich ernst genommen, der Sender ist sogar gewachsen. Naja - willst du es noch über die Finanzen probieren?",
		info: 'In Ungarn wurde dem Radiosender "Klubradio", einem der wenigen oppositionellen Medien, wegen einer solchen Bagatelle die Lizenz entzogen. Mittlerweile ist der Sender nur noch <a href=https://www.klubradio.hu/>übers Internet zu hören</a>. <a href=https://www.tagesschau.de/ausland/europa/ungarn-pressefreiheit-103.html>Hier</a> findest du mehr zum Entzug der Lizenz.',
		answers: [
			{
				text: "Ja, gern.",
	...
	abgabeb: {
		question:
			"Mein Vorschlag wäre eine Steuer, beziehungsweise eine Abgabe, die die Medien zahlen müssen, wenn sie Werbung schalten. Aber damit es da weniger Widerstand gibt, brauchen wir einen guten Namen.",
		answers: [
			{
	...
	schlechterNameB: {
		question:
			"Mhhh. So fällt doch direkt auf, wer weswegen zahlen muss. Da hätte man auch einen besseren Namen finden können. Aber naja - letztlich kommt es darauf an, ob das Instrument wirkt, oder? Machen wir das?",
	...
	klage2: {
		...
		question:
			"Das Urteil des Adrejanischen Gerichtshofs ist durch: Nuppland hat leider nicht Recht bekommen. Das bedeutet, dass ihr nach wie vor schon bei wenigen Verstößen gegen die Rechtsstaatlichkeit mit weniger AU-Geldern rechnen könnt.",
	...
	klage: {
		...
		question:
			"Der Adrejanische Gerichtshof hat sich beraten, Nuppland hat Recht bekommen. Das bedeutet, dass Nuppland erst bei starken Verstößen mit Sanktionen belegt wird. Herzlichen Glückwunsch zum Erfolg vor Gericht!",
		info: "Polen und Ungarn haben vor dem Europäischen Gerichtshof gegen den Rechtsstaatsmechanismus der EU geklagt. Bisher wurde nach Kompromissen gesucht. Zur Zeit wird der Mechanismus trotzdem ausgeführt. Eine abschließende Prüfung steht noch aus.",
		answers: [
			{
...
*/
	...
	vorErgebnis0: {
		...
		question:
			"Du scheinst nicht wirklich viel ändern zu wollen, also würde ich vorschlagen, dass wir direkt zur Wahl vorspringen. Aber da du deinen Einfluss so wenig genutzt hast, haben die Medien wahrscheinlich wenig zu eurem Wahlkampf beigetragen.",
		answers: [
			{
	...
	vorErgebnis1: {
		...
		question:
			"Du scheinst nicht sooo viel ändern zu wollen, also würde ich vorschlagen, dass wir direkt zur Wahl vorspringen. Viel mehr Ideen habe ich leider nicht mehr für deinen Wahlkampf. Insofern haben die Medien wahrscheinlich wenig zu eurem Wahlkampf beigetragen.",
		answers: [
			{
				text: "Okay, dann machen wir halt dort weiter.",
				goto: "ergebnis",
	...
	vorErgebnis2: {
		...
		question:
			"Viel mehr Ideen habe ich leider nicht mehr für deinen Wahlkampf. Was hältst du von einer kurzen Pause, bis die Wahlstattfindet?",
		answers: [
			{
	...
	ergebnis: {
		...
		question:
			"Okay, die Zeit ist vorbei. Schauen wir mal, wie deine Bilanz so aussieht. Bisher gibt es noch $kritischeJournalisten kritische Journalist*innen im Land. $ergebnisErgänzung",
